...
import {monkeypatchEventLoopElement_add, makeOverwriteableEventLoopDefinition, monkeypatchEventLoop_remove} from "./eventLoopEvents.js";

makeOverwriteableEventLoopDefinition();
(function (EventTargetOG, addEventListenerOG, removeEventListenerOG) {
  EventTargetOG.prototype.addEventListener = monkeypatchEventLoopElement_add(monkeypatchCustomEventsAdd(addEventListenerOG));
  EventTargetOG.prototype.removeEventListener = monkeypatchEventLoop_remove(monkeypatchCustomEventsRemove(removeEventListenerOG));
})(EventTarget, addEventListener, removeEventListener);
